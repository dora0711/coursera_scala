...
//    if(elem.retweets > this.left.mostRetweeted.retweets) {
//      if(elem.retweets > this.right.mostRetweeted.retweets) elem
//      else right.mostRetweeted
//    } else {
//      if(this.left.mostRetweeted.retweets > this.right.mostRetweeted.retweets) this.left.mostRetweeted
//      else right.mostRetweeted
//    }
    ...
    if(left.empty) {
      ...
      if(right.empty) {
        ...
        if (leftMostRetweeted.retweets > elem.retweets) {
          if (leftMostRetweeted.retweets > rightMostRetweeted.retweets) leftMostRetweeted else rightMostRetweeted
        } else {
